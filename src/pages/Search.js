            ...
            Blur: {
                ...
                content: {
                    ...
                    Header:{
                        ...
                        text:{
                            text:'Search Page', fontFace: "Bold", fontSize: 128
                        }
                    },
                    SubHeader: {
                        mount: 0.5, x: 960, y: 650,
                        text:{
                            text:'', fontFace: "Regular", fontSize: 48
                        }
                    },
                    Arrows: {
                        Up: {
                            ...
                            Label: {
                                mountX: .5, x: 960,
                                text: {text: "Settings Page", fontFace: "Regular", textAlign: "center", wordWrapWidth: 300, lineHeight: 48}
                            }
                        },
                        Right: {
                            flex: {},
                        ...
                        Left: {
                            ...
                            Label: {
                                mountY: 0.5, y: 24,
                                text: {text: "Menu Widget", fontFace: "Regular", textAlign: "right", wordWrapWidth: 300, lineHeight: 48}
                            }
                        }
                    }
                }
