    ...
    static _template(){
        return {
            ...
            Header:{
                ...
                text:{
                    text:'Settings Page', fontFace: "Bold", fontSize: 128
                }
            },
            Arrows: {
                Up: {
                ...
                Down: {
                    ...
                    Label: {
                        mountX: .5, x: 960,
                        text: {text: "Page with error", fontFace: "Regular", textAlign: "center", wordWrapWidth: 300, lineHeight: 48}
                    },
                    Arrow: {
                        flexItem: {marginTop: 20, marginBottom: 50},
                        mountX: .5, x: 960, rotation: Math.PI,
                        src: Utils.asset("arrow.png")
                    }
                }
            }
