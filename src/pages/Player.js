            ...
            Blur: {
                ...
                content: {
                    ...
                    Header:{
                        ...
                        text:{
                            text:'Player Page', fontFace: "Bold", fontSize: 128
                        }
                    },
                    SubHeader: {
                        mount: 0.5, x: 960, y: 650,
                        text:{
                            text:'Player Page', fontFace: "Regular", fontSize: 48
                        }
                    },
                    Arrows: {
                        Up: {
                            ...
                            Label: {
                                mountX: .5, x: 960,
                                text: {text: "Reload with different params", fontFace: "Regular", textAlign: "center", wordWrapWidth: 300, lineHeight: 48}
                            }
                        },
                        Right: {
                            flex: {},
                        ...
                        Left: {
                            ...
                            Label: {
                                mountY: 0.5, y: 24,
                                text: {text: "Non existing page", fontFace: "Regular", textAlign: "right", wordWrapWidth: 300, lineHeight: 48}
                            }
                        },
                        Enter: {
