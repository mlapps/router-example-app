...
export default class Notification extends Lightning.Component{
    static _template(){
        return {
            alpha: 0, scale: 0.9, w: 1720, h: 100,
            transitions: {
                alpha: {duration: .3, timingFunction: 'cubic-bezier(0.17, 0.9, 0.32, 1.3)'},
                scale: {duration: .3, timingFunction: 'cubic-bezier(0.17, 0.9, 0.32, 1.3)'}
            },
            Background:{
